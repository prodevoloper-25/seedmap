...
# Example usage
image_path = 'C:/Users/admin/Desktop/silt.jpg'  # Replace with the path to your test image
soil_type, confidence = predict_soil_type(image_path)
print(f"Predicted Soil Type: {soil_type} with confidence: {confidence:.2f}%")

parameters = {
    "lat": "15.4824",
    "lon": "73.8522",
    # "exclude": "minutes,hourly,daily,alerts",
...
# Step 1: Define an extended dictionary of crops with their optimal temperature and soil type ranges
crop_data = {
...
# Step 2: Define a function to find suitable crops based on temperature and soil type
def find_suitable_crops(temperature, soil_type):
    ...
    for crop, requirements in crop_data.items():
        ...
        # Check if the temperature and soil type fall within the crop's optimal range
        if temp_range[0] <= temperature <= temp_range[1] and soil_type in soil_types:
            suitable_crops.append(crop)

    return suitable_crops

# Step 3: Input values for testing
current_temperature = temp  # Example temperature of the area
current_soil_type = soil_type # Example soil type

# Step 4: Get suitable crops
recommended_crops = find_suitable_crops(current_temperature, current_soil_type)

# Step 5: Display the result
if recommended_crops:
    print("The most suitable crops for the given temperature and soil type are:", recommended_crops)
else:
    print("No suitable crops found for the given temperature and soil type.")
